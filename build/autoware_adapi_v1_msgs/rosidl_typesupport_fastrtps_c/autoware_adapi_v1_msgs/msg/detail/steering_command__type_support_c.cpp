...
#include "autoware_adapi_v1_msgs/msg/detail/steering_command__rosidl_typesupport_fastrtps_c.h"
...
using _SteeringCommand__ros_msg_type = autoware_adapi_v1_msgs__msg__SteeringCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: steering_tire_velocity
  {
...
size_t get_serialized_size_autoware_adapi_v1_msgs__msg__SteeringCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SteeringCommand__ros_msg_type * ros_message = static_cast<const _SteeringCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SteeringCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_adapi_v1_msgs__msg__SteeringCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_adapi_v1_msgs
size_t max_serialized_size_autoware_adapi_v1_msgs__msg__SteeringCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_adapi_v1_msgs__msg__SteeringCommand;
    is_plain =
      (
...
static size_t _SteeringCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_adapi_v1_msgs__msg__SteeringCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, msg, SteeringCommand)() {
