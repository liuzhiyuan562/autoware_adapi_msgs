...
static const _SendMrmRequest_Request_type_support_symbol_names_t _SendMrmRequest_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SendMrmRequest_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SendMrmRequest_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SendMrmRequest_Request)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SendMrmRequest_Request_message_type_support_handle;
}
...
static const _SendMrmRequest_Response_type_support_symbol_names_t _SendMrmRequest_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SendMrmRequest_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SendMrmRequest_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SendMrmRequest_Response)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SendMrmRequest_Response_message_type_support_handle;
}
...
static const _SendMrmRequest_type_support_symbol_names_t _SendMrmRequest_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_adapi_v1_msgs, srv, SendMrmRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, srv, SendMrmRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_adapi_v1_msgs, srv, SendMrmRequest)() {
  return &::autoware_adapi_v1_msgs::srv::rosidl_typesupport_c::SendMrmRequest_service_type_support_handle;
}
