...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__init(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request * msg)
{
  ...
  // request
  if (!autoware_adapi_v1_msgs__msg__MrmRequest__init(&msg->request)) {
    autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__fini(msg);
    return false;
  }
  return true;
}
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__fini(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request * msg)
{
  ...
  // request
  autoware_adapi_v1_msgs__msg__MrmRequest__fini(&msg->request);
}
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__are_equal(const autoware_adapi_v1_msgs__srv__SendMrmRequest_Request * lhs, const autoware_adapi_v1_msgs__srv__SendMrmRequest_Request * rhs)
{
  ...
  // request
  if (!autoware_adapi_v1_msgs__msg__MrmRequest__are_equal(
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__create()
{
  ...
  autoware_adapi_v1_msgs__srv__SendMrmRequest_Request * msg = (autoware_adapi_v1_msgs__srv__SendMrmRequest_Request *)allocator.allocate(sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request));
  bool success = autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__init(msg);
  if (!success) {
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence__init(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_adapi_v1_msgs__srv__SendMrmRequest_Request * data = NULL;

  if (size) {
    data = (autoware_adapi_v1_msgs__srv__SendMrmRequest_Request *)allocator.zero_allocate(size, sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__fini(&data[i - 1]);
      }
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence__fini(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence * array = (autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence *)allocator.allocate(sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence__init(array, size);
  if (!success) {
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence__destroy(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence__are_equal(const autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence * lhs, const autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_adapi_v1_msgs__srv__SendMrmRequest_Request * data =
      (autoware_adapi_v1_msgs__srv__SendMrmRequest_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_adapi_v1_msgs__srv__SendMrmRequest_Request__copy(
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__init(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response * msg)
{
  ...
  if (!autoware_adapi_v1_msgs__msg__ResponseStatus__init(&msg->status)) {
    autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_adapi_v1_msgs__srv__SendMrmRequest_Response * msg = (autoware_adapi_v1_msgs__srv__SendMrmRequest_Response *)allocator.allocate(sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response));
  bool success = autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence__init(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_adapi_v1_msgs__srv__SendMrmRequest_Response * data = NULL;

  if (size) {
    data = (autoware_adapi_v1_msgs__srv__SendMrmRequest_Response *)allocator.zero_allocate(size, sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence__fini(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence * array = (autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence *)allocator.allocate(sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence__destroy(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence__are_equal(const autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence * lhs, const autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_adapi_v1_msgs__srv__SendMrmRequest_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_adapi_v1_msgs__srv__SendMrmRequest_Response * data =
      (autoware_adapi_v1_msgs__srv__SendMrmRequest_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_adapi_v1_msgs__srv__SendMrmRequest_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
