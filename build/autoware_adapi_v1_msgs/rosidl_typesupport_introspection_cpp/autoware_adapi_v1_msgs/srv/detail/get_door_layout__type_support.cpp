...
void fetch_function__GetDoorLayout_Response__doors(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const autoware_adapi_v1_msgs::msg::DoorLayout *>(
    get_const_function__GetDoorLayout_Response__doors(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_adapi_v1_msgs::msg::DoorLayout *>(untyped_value);
  value = item;
}

void assign_function__GetDoorLayout_Response__doors(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<autoware_adapi_v1_msgs::msg::DoorLayout *>(
    get_function__GetDoorLayout_Response__doors(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_adapi_v1_msgs::msg::DoorLayout *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetDoorLayout_Response_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__GetDoorLayout_Response__doors,  // fetch(index, &value) function pointer
    assign_function__GetDoorLayout_Response__doors,  // assign(index, value) function pointer
