...
static rosidl_typesupport_introspection_c__MessageMember autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__SteeringFactor_message_member_array[8] = {
  {
    "pose",  // name
