...
bool autoware_adapi_v1_msgs__msg__diag_node_struct__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_adapi_v1_msgs.msg._diag_node_struct.DiagNodeStruct", full_classname_dest, 59) == 0);
  }
  autoware_adapi_v1_msgs__msg__DiagNodeStruct * ros_message = _ros_message;
  {  // path
...
{
  /* NOTE(esteve): Call constructor of DiagNodeStruct */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_adapi_v1_msgs.msg._diag_node_struct");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DiagNodeStruct");
