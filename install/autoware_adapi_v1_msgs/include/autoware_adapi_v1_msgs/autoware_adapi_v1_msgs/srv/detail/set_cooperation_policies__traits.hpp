...
inline void to_flow_style_yaml(
  const SetCooperationPolicies_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: policies
...
inline std::string to_yaml(const SetCooperationPolicies_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const autoware_adapi_v1_msgs::srv::SetCooperationPolicies_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_adapi_v1_msgs::srv::SetCooperationPolicies_Request & msg)
{
...
inline void to_flow_style_yaml(
  const SetCooperationPolicies_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: status
...
inline std::string to_yaml(const SetCooperationPolicies_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use autoware_adapi_v1_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const autoware_adapi_v1_msgs::srv::SetCooperationPolicies_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  autoware_adapi_v1_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use autoware_adapi_v1_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const autoware_adapi_v1_msgs::srv::SetCooperationPolicies_Response & msg)
{
  return autoware_adapi_v1_msgs::srv::to_yaml(msg);
}
