...
void fetch_function__SetCooperationPolicies_Request__policies(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const autoware_adapi_v1_msgs::msg::CooperationPolicy *>(
    get_const_function__SetCooperationPolicies_Request__policies(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_adapi_v1_msgs::msg::CooperationPolicy *>(untyped_value);
  value = item;
}

void assign_function__SetCooperationPolicies_Request__policies(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<autoware_adapi_v1_msgs::msg::CooperationPolicy *>(
    get_function__SetCooperationPolicies_Request__policies(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetCooperationPolicies_Request_message_member_array[1] = {
  {
    ...
    fetch_function__SetCooperationPolicies_Request__policies,  // fetch(index, &value) function pointer
    assign_function__SetCooperationPolicies_Request__policies,  // assign(index, value) function pointer
