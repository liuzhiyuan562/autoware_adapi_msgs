...
autoware_adapi_v1_msgs__msg__Heartbeat__init(autoware_adapi_v1_msgs__msg__Heartbeat * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    autoware_adapi_v1_msgs__msg__Heartbeat__fini(msg);
    return false;
  }
  // seq
  return true;
...
autoware_adapi_v1_msgs__msg__Heartbeat__create()
{
  ...
  autoware_adapi_v1_msgs__msg__Heartbeat * msg = (autoware_adapi_v1_msgs__msg__Heartbeat *)allocator.allocate(sizeof(autoware_adapi_v1_msgs__msg__Heartbeat), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autoware_adapi_v1_msgs__msg__Heartbeat));
  bool success = autoware_adapi_v1_msgs__msg__Heartbeat__init(msg);
  if (!success) {
...
autoware_adapi_v1_msgs__msg__Heartbeat__Sequence__init(autoware_adapi_v1_msgs__msg__Heartbeat__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_adapi_v1_msgs__msg__Heartbeat * data = NULL;

  if (size) {
    data = (autoware_adapi_v1_msgs__msg__Heartbeat *)allocator.zero_allocate(size, sizeof(autoware_adapi_v1_msgs__msg__Heartbeat), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autoware_adapi_v1_msgs__msg__Heartbeat__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        autoware_adapi_v1_msgs__msg__Heartbeat__fini(&data[i - 1]);
      }
...
autoware_adapi_v1_msgs__msg__Heartbeat__Sequence__fini(autoware_adapi_v1_msgs__msg__Heartbeat__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      autoware_adapi_v1_msgs__msg__Heartbeat__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_adapi_v1_msgs__msg__Heartbeat__Sequence * array = (autoware_adapi_v1_msgs__msg__Heartbeat__Sequence *)allocator.allocate(sizeof(autoware_adapi_v1_msgs__msg__Heartbeat__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autoware_adapi_v1_msgs__msg__Heartbeat__Sequence__init(array, size);
  if (!success) {
...
autoware_adapi_v1_msgs__msg__Heartbeat__Sequence__destroy(autoware_adapi_v1_msgs__msg__Heartbeat__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autoware_adapi_v1_msgs__msg__Heartbeat__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autoware_adapi_v1_msgs__msg__Heartbeat__Sequence__are_equal(const autoware_adapi_v1_msgs__msg__Heartbeat__Sequence * lhs, const autoware_adapi_v1_msgs__msg__Heartbeat__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_adapi_v1_msgs__msg__Heartbeat__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_adapi_v1_msgs__msg__Heartbeat__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_adapi_v1_msgs__msg__Heartbeat);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_adapi_v1_msgs__msg__Heartbeat * data =
      (autoware_adapi_v1_msgs__msg__Heartbeat *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_adapi_v1_msgs__msg__Heartbeat__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_adapi_v1_msgs__msg__Heartbeat__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_adapi_v1_msgs__msg__Heartbeat__copy(
