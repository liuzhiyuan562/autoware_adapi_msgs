...
void fetch_function__DynamicObjectKinematics__predicted_paths(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const autoware_adapi_v1_msgs::msg::DynamicObjectPath *>(
    get_const_function__DynamicObjectKinematics__predicted_paths(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_adapi_v1_msgs::msg::DynamicObjectPath *>(untyped_value);
  value = item;
}

void assign_function__DynamicObjectKinematics__predicted_paths(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<autoware_adapi_v1_msgs::msg::DynamicObjectPath *>(
    get_function__DynamicObjectKinematics__predicted_paths(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_adapi_v1_msgs::msg::DynamicObjectPath *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DynamicObjectKinematics_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__DynamicObjectKinematics__predicted_paths,  // fetch(index, &value) function pointer
    assign_function__DynamicObjectKinematics__predicted_paths,  // assign(index, value) function pointer
